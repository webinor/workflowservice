    ...
    implements WorkflowEventHandlerInterface
{
    ...
    public function execute(
        ...
        Log::info(
            '[WORKFLOW:FEE_NOTE_SIGNED] ===== START =====',
            [
                'document_uuid' =>
                    $documentUuid,
        ...
        */
        ...
        if (!$actorId) {
            ...
            Log::warning(
                '[WORKFLOW:FEE_NOTE_SIGNED] Aucun actorId fourni.',
                [
                    'document_uuid' =>
                        $documentUuid,
                ]
        ...
        */
        ...
        $notificationData = array_merge(
            ...
            [
                ...
                'message' =>
                    'La note de frais a été signée et peut poursuivre son processus de traitement.',
            ]
        );
        ...
        */
        ...
        Log::info(
            '[WORKFLOW:FEE_NOTE_SIGNED] Final notification data',
            [
                'document_id' =>
                    $documentUuid,
